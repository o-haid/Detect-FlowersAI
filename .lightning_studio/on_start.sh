...
source .env && python3 $HOME/.openclaw/model_proxy.py &
source .env && OPENCLAW_THEME=$LIGHTNING_THEME openclaw gateway --port 18789 --verbose --token $OPENCLAW_GATEWAY_TOKEN
